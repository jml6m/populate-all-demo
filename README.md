...
- [lychee](https://github.com/lycheeverse/lychee) (only required for `npm run lint:docs`, the Markdown link/anchor check). Install it with `cargo install lychee` or download a release binary onto your `PATH`. CI installs it automatically.
