...
| **MikroORM**<br>_(Node.js)_  | [Populating relations](https://mikro-orm.io/docs/populating-relations)<br>Supports wildcards `populate: ['*']`.<br>**Tested version:** v6.6.13.                                                                                                                         | **Partial counterexample in this test set.** Wildcard population hydrated a cyclic relation successfully, and serialization also succeeded via MikroORM entity serialization behavior; this is not a confirmed negative-gap case in the same way as the others. | —                                                                                                                                 |
