...
![Execution Time by Dataset Tier](figures/time-by-tier.png)
...
![Scaling: Time vs Node Count](figures/scaling-curve.png)
...
![Heap Delta: Tarjan SCC vs Two-Pass Wire](figures/memory-comparison.png)
